...
<body>
	...
	<!-- 过滤条件 -->
	<div id="QueryArea">
		<form action="${pageContext.request.contextPath }/sys/type/foodType_update" method="get">
					...
					<c:when test="${not empty requestScope.listFood}">
						<c:forEach var="foodType" items="${requestScope.listFood}">
							<tr>
								...
								<td>
									<a href="${pageContext.request.contextPath }/servlet/FoodTypeServlet?id=${foodType.id}&method=update" class="FunctionButton">更新</a> 
