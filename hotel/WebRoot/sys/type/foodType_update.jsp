...
<div id="MainArea">
	<!-- 表单内容 -->
	<form action="${pageContext.request.contextPath }/servlet/FoodTypeServlet?method=viewUpdate" method="post" name="form1">
					...
					<table cellpadding="0" cellspacing="0" class="mainForm">
						<tr>
							...
							<td>
								...
								<input type="hidden" name="id"  value="${requestScope.foodTypeId }"/>
								<!-- <script type="text/javascript">alert("隐藏域的值是 "+document.form1.id.value)</script> -->
