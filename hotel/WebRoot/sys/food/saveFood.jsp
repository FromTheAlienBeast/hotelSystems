...
<div id="MainArea">
	<!-- 表单内容 -->
	<form action="${pageContext.request.contextPath}/servlet/DetalServlet?method=save" method="post" >
		<!-- 本段标题（分段标题） -->
            ...
            <div class="ItemBlock">
				<div class="ItemBlock2">
                    ...
                    <tr>
						...
						<tr>
							<td width="80px">菜名</td>
							<td><input type="text" name="foodName" class="InputStyle" value="" id="t"/> *</td>
						</tr>
						<tr>
							<td>价格</td>
