	    ...
	    <li class="level1">
            ...
            <ul class="MenuLevel2">
            	<li class="level2 level2Style">
                    <a target="right" href="${pageContext.request.contextPath}/servlet/DinnerTableServlet?method=listAllTable">餐桌管理</a>
				</li>
                <li class="level2 level2Style">
                	<a target="right" href="${pageContext.request.contextPath}/servlet/FoodTypeServlet?method=listFoodType">菜系管理</a>
				</li>
                <li class="level2 level2Style">
                	<a target="right" href="${pageContext.request.contextPath}/servlet/DetalServlet?method=listFood">菜品管理</a>
				</li>
                <li class="level2 level2Style">
